...
int main(){
    ...
    printf("Der Datentyp %s hat die Speichergroesze %d und liegt im Zahlenbereich zwischen %d und %d \n\r", "char", sizeof(char), std::numeric_limits<char>::min(), std::numeric_limits<char>::max() );

    //unsigned char

     printf("Der Datentyp %s hat die Speichergroesze %d und liegt im Zahlenbereich zwischen %u und %llu \n\r", "unsigned char", sizeof(unsigned char), std::numeric_limits<unsigned char>::min(), std::numeric_limits<unsigned char>::max() );
